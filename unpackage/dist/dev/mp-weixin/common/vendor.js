...
const pages = [
  ...
  {
    path: "pages/repayment-list/repayment-list",
    style: {
...
const tabBar = {
  ...
  list: [
    ...
    {
      pagePath: "pages/repayment-list/repayment-list",
...
const globalStyle = {
  ...
  navigationBarTitleText: "repayment-plan",
...
const k = true, I = "mp-weixin", C = b([]), A = I, P = b('{\n    "address": [\n        "127.0.0.1",\n        "172.24.22.123"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/mysoft/hbuilder/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = b('[{"provider":"aliyun","spaceName":"my-first-cloud","spaceId":"mp-e07cf891-0287-4d55-8132-e3a41880bcf2","clientSecret":"sKgJ+0+Ts2daeBslyJ0kZQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__D9A0707";
} catch (e2) {
